            ...
            {platformAdminNavItems.map((item) => (
              <Link
                ...
                className={cn(
                  'flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors',
                  location.pathname === item.to
                    ? 'bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 text-sidebar-strong ring-1 ring-fuchsia-400/30'
                    : 'text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-strong'
                )}
              >
              ...
              <div className="space-y-0.5">
                {platformLinks.map((p) => (
                  <a
                    ...
                    className="group flex items-center gap-2.5 px-2 py-1.5 rounded-md text-xs font-medium text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-strong transition-colors"
                  >
