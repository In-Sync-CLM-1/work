...
CREATE FUNCTION "public"."auto_generate_task_number"() RETURNS "trigger"
...
CREATE FUNCTION "public"."auto_set_closed_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE FUNCTION "public"."auto_set_completed_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE FUNCTION "public"."dispatch_external_notification"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE FUNCTION "public"."notify_on_new_comment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_task RECORD;
...
CREATE FUNCTION "public"."notify_on_task_assignment"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE FUNCTION "public"."notify_on_task_update"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- Status changed
...
CREATE FUNCTION "public"."setup_new_organization"("p_org_name" "text") RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_user_id UUID;
...
CREATE TRIGGER "trg_check_admin_limit" BEFORE INSERT OR UPDATE ON "public"."user_roles" FOR EACH ROW EXECUTE FUNCTION "public"."check_admin_limit"();
...
CREATE TRIGGER "trg_dispatch_external_notification" AFTER INSERT ON "public"."notifications" FOR EACH ROW EXECUTE FUNCTION "public"."dispatch_external_notification"();
...
CREATE TRIGGER "trg_notify_on_new_comment" AFTER INSERT ON "public"."task_comments" FOR EACH ROW EXECUTE FUNCTION "public"."notify_on_new_comment"();
...
CREATE TRIGGER "trg_notify_on_task_update" AFTER UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."notify_on_task_update"();
...
CREATE TRIGGER "trg_support_tickets_updated_at" BEFORE UPDATE ON "public"."support_tickets" FOR EACH ROW EXECUTE FUNCTION "public"."touch_support_ticket_updated_at"();
...
CREATE TRIGGER "trg_tasks_auto_closed_at" BEFORE UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."auto_set_closed_at"();
...
CREATE TRIGGER "trg_tasks_auto_completed_at" BEFORE UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."auto_set_completed_at"();
...
CREATE TRIGGER "trg_tasks_auto_number" BEFORE INSERT ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."auto_generate_task_number"();
...
CREATE TRIGGER "trg_tasks_log_status_change" AFTER UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."log_status_change"();
...
CREATE TRIGGER "trg_tasks_notify_assignment" AFTER INSERT OR UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."notify_on_task_assignment"();
